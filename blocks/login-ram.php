...
?>
	  ...
	  <tr >
		  <td><?php	
			...
			if( isset( $_GET["msg"]))//ADDED BY RAM
			{
			$msg = $_GET["msg"];
			}
			else//ADDED BY RAM
			...
			?>
                ...
                <form name="form" method="post" action="<?php echo $APP_URL; ?>/admin.php" name="casLoginForm" style="margin-bottom:0;" >
                  ...
                  <span class="feInstruction">		
                    ...
                    <br />
             		<br />
      				If you are not a UM staff, click here to <a href="register.php">register</a>.<br><br>Please download the  guidelines <a href="../public/umrefjournal guideline.pdf" target="_blank">here</a>.</span>
                </form>
              <?php	
	      ...
	      ?> 
                ...
                <form name="form" method="post" action="<?php echo $APP_URL; ?>/login.php" style="margin-bottom:0;" >
                  ...
                  <span class="feInstruction">		
                    ...
                    <br />
             		<br />
      				If you are not a member, click here to <a href="register.php">register</a>.</span>
                </form>
