        ...
        <tr>
          ...
          <td width="750" height="25" colspan="2">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><div align="left" class="breadcrumb"><a href="admin.php">Home</a> &gt; <a href="author_map_management.php">Author Groups Management</a> &gt; Ungrouped Authors</div></td>
              </tr>
            </table>
          </td>
        </tr>
        <tr>
          <td valign="top">
            <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" background="images/tajukpanjang750.png"><span class="fontWhiteBold">Ungrouped Author List</span>
              </tr>
              <tr>
                <td>
                        ...
                        <div class="adminContent authorMap">
                          <div class="searchBar">
                            <form action="#" method="get">
                              <a href="author_map_management_ungroup.php">All</a>
                              <span>|</span>
                              <label for="search">Ungrouped author search:</label>
                              <input type="text" name="search" />
                              <input type="submit" name="submit" value="Search" />
                            </form>
                            <div>
                              <a href="author_map_management.php">View author groups</a>
                            </div>
                            <hr />  
                          </div>
